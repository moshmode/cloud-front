      ...
      <div class="t-infor-wrap">
        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            ...
            <h3 class="hLh30">
              <span class="fsize24 c-333">{{ teacher.name }}&nbsp;{{ teacher.level === 1 ? '初级讲师' : '高级讲师' }}</span>
            </h3>
            <section class="mt10">
...
export default {
  ...
  methods: {
    getTeacherInfo() {
      teacher.getTeacherInfo(this.teacherId).then(response => {
        this.teacher = response.data.teacher
      })
    },
    getCourseByTeacherId() {
      course.getCourseList(this.current, this.limit, this.courseQuery).then(response => {
